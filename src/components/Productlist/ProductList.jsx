        ...
        {products.map((product) => (
          <div key={product.id} className="relative mb-4 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
            ...
            <div className="mt-4 px-4 pb-5">
              ...
              <Link to={`/v1/products/${product._id}`}> <h6 href="#" className="flex items-center rounded-md bg-color2 px-5 py-2.5 text-center text-sm font-medium text-color0 hover:bg-color0 hover:text-color2 hover:border-2 hover:border-color2 " onClick={() => handleBuyClick(product.id)}>
