...
export default function Footer() {
        ...
        <div className="grid lg:grid-cols-3">
          ...
          <div className="mx-12 flex flex-row justify-around">
            ...
            <div className="flex flex-col">
              <h6 className="mb-2 font-medium uppercase text-color1"><strong>CATEGORIES 1</strong></h6>
              <ul className="flex flex-col items-center">
                {categories.map((category, index) => (
                  <li key={index} className="mb-2 text-color1">
                    {category}
                  </li>
                ))}
              </ul>
            ...
            {/* category  2*/}
            <div className="flex flex-col">
              <h6 className="mb-2 font-medium uppercase text-color1">
                <strong>CATEGORIES 2</strong></h6>
              <ul className="flex flex-col items-center text-color1">
                {categories.map((category, index) => (
                  <li key={index} className="mb-2 text-color1">
                    {category}
                  </li>
                ...
                <div
                  ...
                  <div className='flex justify-center'>
                    <div className="relative mr-2" data-te-input-wrapper-init>
                      <input
                        type="text"
                        className="peer block min-h-[auto] w-70 border-2 border-gray-300 bg-white h-10 px-5 pr-16  px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:placeholder:text-secondary-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                        id="exampleFormControlInput1"
                        placeholder="Email address"
                      />
                      <label
                        htmlFor="exampleFormControlInput1"
                        className="pointer-events-none absolute text-color1 left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-secondary-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-secondary-200 dark:peer-focus:text-secondary-200"
                      >
                        Email address
                      </label>
                    </div>
  ...
  <div className="my-3  flex justify-center items-center mx-9 justify-end">
    <div className=" text-c1 hover:underline hover:cursor-pointer mx-4">Contact us</div>
