...
export default function Features (){
    return(
        <div className="flex justify-around my-8">
            ...
            <div className={`relative rounded-full w-32 h-32 grid place-items-center mx-auto bg-color2`}>
                <GiTicket className="text-white w-32 h-32 p-3"/>
            </div>
            ...
            <div className="text-center">
            <div className={`relative rounded-full w-32 h-32 grid place-items-center mx-auto bg-color2`}>
                <MdSecurity className="text-white w-32 h-32 p-3"/>
            </div>
            <div className="flex justify-center flex-col mt-5">
            ...
            <div className="text-center">
            <div className={`relative rounded-full w-32 h-32 grid place-items-center mx-auto bg-color2 `}>
                <BiSupport className="text-white w-32 h-32 p-3" />
            </div>
            <div className="flex justify-center flex-col mt-5">
