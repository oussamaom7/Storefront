...
function ProductPage() {
  return (
    <div className="flex flex-col items-center">
      ...
      {/* Use Paper component for the form with a blue background */}
      <Paper elevation={3} className="p-4 mb-4" style={{ backgroundColor: '#C0C0C0' }}>
        <div className="flex items-center justify-between">
          <div className="w-1/2 mr-4">
            <img src={wac} alt="wacvssun" className="max-w-full h-auto" />
          </div>
          <div className="w-1/2 flex flex-col">
            {/* You can use Typography components for labels */}
