  ...
  return (
    ...
    <NavbarLogo/>
      <div className="flex justify-between">
        ...
        <div className='flex flex-col mx-auto my-10 max-w-2xl w-1/3'>
          <div>
            <div>
                ...
                <div>
                  ...
                  <div className="mt-2.5 relative">
                    <input
                      ...
                      className="w-full block rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6"
                    />
